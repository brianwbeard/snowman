const CACHE = 'snowman-v1.11';
const CORE = ['./','./index.html','./styles.css?v=1.11','./words.js?v=1.11','./app.js?v=1.11','./manifest.webmanifest?v=1.11','./icon-180.png?v=1.11','./icon-192.png','./icon-512.png','/learn-to-readle/answers.js'];
