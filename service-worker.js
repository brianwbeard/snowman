const CACHE = 'snowman-v1.8';
const CORE = ['./','./index.html','./styles.css?v=1.8','./words.js?v=1.8','./app.js?v=1.8','./manifest.webmanifest?v=1.8','./icon-180.png?v=1.8','./icon-192.png','./icon-512.png','/learn-to-readle/answers.js'];
