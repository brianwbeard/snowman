const CACHE = 'snowman-v1.9';
const CORE = ['./','./index.html','./styles.css?v=1.9','./words.js?v=1.9','./app.js?v=1.9','./manifest.webmanifest?v=1.9','./icon-180.png?v=1.9','./icon-192.png','./icon-512.png','/learn-to-readle/answers.js'];
